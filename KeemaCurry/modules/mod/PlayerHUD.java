...
//							fr.getStringWidth(name + " " + Float.toString(Math.round(health*10f)/10f) + "Åòc\u2764 ÅòrMP:" + MP + 1) * health / player.getMaxHealth(),
//							sr.getScaledHeight() - (10 * count) + 10, color.getRGB());//255, 57, 66, 200    new Color(92, 255, 135,180).getRGB()
//					
					fr.drawStringWithShadow(name + " " + Float.toString(Math.round(health*10f)/10f) + "Åòc\u2764 ÅòrMP:" + MP,x + 1,y + offset, -1);
					count ++;
				}
			}
		}
