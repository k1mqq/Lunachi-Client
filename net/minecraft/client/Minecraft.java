...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public FontRenderer frUnUnicode;
    ...
    private void init() throws LWJGLException, IOException
    {
        ...
        this.frUnUnicode = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
    ...
    private void middleClickMouse()
    {
        if (this.objectMouseOver != null && this.objectMouseOver.typeOfHit != RayTraceResult.Type.MISS)
        {
            ...
            if (itemstack.getItem() == null)
            {
                ...
                if (this.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    s1 = ((ResourceLocation)Block.REGISTRY.getNameForObject(this.world.getBlockState(this.objectMouseOver.getBlockPos()).getBlock())).toString();
                }
