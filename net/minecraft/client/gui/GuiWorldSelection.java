...
public class GuiWorldSelection extends GuiScreen implements GuiYesNoCallback
{
    ...
    private GuiButton backupButton;
    ...
    public void postInit()
    {
        ...
        this.backupButton = this.addButton(new GuiButton(100, this.width / 2 + 82 + 72 +12, this.height - 28, 72, 20, "バックアップ"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if(button.id == 100) {
            	guilistworldselectionentry.backup();
            }
        }
    }
    ...
    public void selectWorld(@Nullable GuiListWorldSelectionEntry entry)
    {
        ...
        this.backupButton.enabled = flag;
    }
}
