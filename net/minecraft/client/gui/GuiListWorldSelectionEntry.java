...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry
{
    ...
    void backup() {
    	ISaveFormat isaveformat2 = this.client.getSaveLoader();
    	File srcDir = isaveformat2.getFile(this.worldSummary.getFileName(), "icon.png").getParentFile();
        File destDir = new File(Minecraft.getMinecraft().mcDataDir, "BackUp/" + srcDir.getName());
        OpenGlHelper.openFile(destDir);
