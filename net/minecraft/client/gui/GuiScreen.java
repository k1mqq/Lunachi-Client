...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void drawHoveringText(List<String> textLines, int x, int y)
    {
        if (!textLines.isEmpty())
        {
            ...
            int l = -267386864;
            if(Client.getModuleByName("UniqueItems").isEnabled() && (!(Minecraft.getMinecraft().currentScreen instanceof GuiChat)&& (!textLines.get(0).contains("Åòf") || textLines.get(0).contains("Åòl") || textLines.get(0).contains("Åò8")))) {
            	int color1 = new Color(120,20,20,240).getRGB();
            	int color2 = new Color(255,70,70, 220).getRGB();
	            ...
	            int i1 = 1347420415;
	            int j1 = 1344798847;
	            this.drawGradientRect(l1 - 3, i2 - 3 + 1, l1 - 3 + 1, i2 + k + 3 - 1, color2, color2);
	           this.drawGradientRect(l1 + i + 2, i2 - 3 + 1, l1 + i + 3, i2 + k + 3 - 1, color2, color2);
	            this.drawGradientRect(l1 - 3, i2 - 3, l1 + i + 3, i2 - 3 + 1, color2, color2);
	           this.drawGradientRect(l1 - 3, i2 + k + 2, l1 + i + 3, i2 + k + 3, color2, color2);
            }else {
