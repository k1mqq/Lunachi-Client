...
public class GuiSleepMP extends GuiChat
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(2, this.width - 100, this.height - 40, 70, 20, "永眠回避"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.id == 1)
        {
        	...
        	mc.player.wakeUpPlayer(false, true, true);
        	Client.addChatMessage("永眠バグが起きた場合はリロードをお勧めします");
