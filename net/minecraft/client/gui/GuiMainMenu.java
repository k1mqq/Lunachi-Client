...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation SPLASH_TEXTS = new ResourceLocation("kima/splashes.txt");
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(100, this.width / 2 -100, j + 72 - 24, 98, 20, "TUSBŒöŽ®"));
        this.buttonList.add(new GuiButton(101, this.width / 2 +2, j + 72 - 24, 98, 20, "Discord"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = "Lunachi-Client v" + Client.version;
